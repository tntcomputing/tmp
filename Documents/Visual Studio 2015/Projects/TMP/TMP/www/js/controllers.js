...
.controller('ProjectCtrl', function ($scope, $stateParams,pouchDBService) {
    var project = {};
    //project._id = $stateParams.projectId;
    pouchDBService.db.get($stateParams.projectId).then(function (response) {
        //Held locally
        response.description = "Nothing here rigth now, but this is where you can enter your own information about your project";
        response.smallImage = "https://placeholdit.imgix.net/~text?txtsize=6&txt=img&w=30&h=30";
        response.mainImage = "https://placeholdit.imgix.net/~text?txtsize=33&txt=image&w=200&h=200";
